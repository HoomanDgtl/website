...
const PeaceHandIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14.1488 9.47163V3.61153C14.1488 2.72151 13.4273 2 12.5373 2C11.6473 2 10.9258 2.72151 10.9258 3.61153V8.44611" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
        <path d="M16.346 12.841L18.5217 5.58862C18.7755 4.74265 18.2886 3.85248 17.4394 3.60984C16.5943 3.3684 15.7142 3.8609 15.4779 4.70743L14.1484 9.47149" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
        ...
        <path d="M11.7192 12.2596C11.9239 11.6921 11.8998 11.0672 11.6518 10.5172L10.5787 8.13678C10.2181 7.33697 9.27613 6.98258 8.4778 7.34641C7.66469 7.71696 7.31885 8.68636 7.71382 9.4879L7.84946 9.76316" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
