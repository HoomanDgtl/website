...
heroSection:
  title: <span class="!text-[#8C8E91]">The Decentralized<br class="md:hidden" /> Cloud</span><br class="md:block hidden" /> Built for <br class="md:hidden"/> AI's Next Frontier
  description: <span class="text-[#8C8E91]">Unlock global GPU power at a <br class='md:hidden'/> fraction of the cost</span>
  cards: 
