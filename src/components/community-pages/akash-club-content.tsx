        ...
        <section className="px-4 py-10 md:px-10 md:py-10 lg:px-[240px] lg:py-10">
            <div className="mx-auto flex max-w-[1240px] flex-col gap-12 lg:flex-row lg:gap-20">
                ...
                <div className="flex flex-col items-center lg:w-1/2">
                    <div className="flex aspect-[580/596] w-full items-center justify-center overflow-hidden rounded-[20px] border border-[#e4e4e7] bg-gray-100">
                        {/* ADD IMAGE HERE: Replace with actual image from public folder */}
                        <p className="text-sm text-gray-400">[ Add image here — community club hero ]</p>
                    </div>
                ...
                <div className="flex flex-col gap-12 lg:w-1/2">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="text-base text-[#71717a]">The Official Community Hub</p>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col">
                            ...
                            <p className="mt-1 text-base text-[#687076]">
                                Move beyond price speculation and master the fundamentals of decentralized infrastructure.
                            </p>
                        </div>
                        <div className="flex flex-col gap-8 rounded-md border border-[#e5e5e5] p-6">
                            {[
                                {
                                    emoji: "🗓️",
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="rounded-md border border-[#e5e5e5] p-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="mt-1 text-sm text-[#687076] md:text-base">
