        ...
        <section className="px-4 py-10 md:px-10 md:py-10 lg:px-[320px] lg:py-10">
            <div className="mx-auto flex max-w-[1080px] flex-col items-center gap-6">
                ...
                <div className="flex flex-col items-center gap-4">
                    <h2 className="text-center text-2xl font-bold text-[#09090b] dark:text-foreground md:text-[32px] md:leading-10">
                        Power Your Applications with Decentralized Compute
                    </h2>
                    <p className="max-w-[1080px] text-center text-base leading-6 text-[#71717a] dark:text-para">
                ...
                <div className="flex w-full flex-col gap-6 items-start lg:flex-row">
                    {/* Left: Feature list */}
                    <div className="flex flex-col gap-10 rounded-md border border-[#e5e5e5] dark:border-defaultBorder p-6 lg:w-1/2">
                    ...
                    <div className=" relative rounded-md lg:w-1/2 overflow-hidden ">
                        <img src="/images/welcome/dev.png" alt="Akash Console" className="w-full h-full object-cover absolute top-0" />
                        <div className="relative lg:px-[72px] lg:py-20   p-8 flex flex-col gap-8">
