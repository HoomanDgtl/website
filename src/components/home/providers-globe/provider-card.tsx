    ...
    <div className="relative">
      ...
      <div className="bg-[#E3E3E3] dark:bg-[#212123] rounded-[20px] px-6 py-5 min-w-[340px] relative z-10">
        <div className="flex justify-between items-center">
          ...
          {provider.audited && (
            <span className="bg-[#A6FA99] text-[#0C3205] text-xs px-2.5 py-1.5 rounded-full flex items-center gap-1.5 font-medium">
              Audited
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_596_1125)">
        ...
        <h2 className="text-base lg:text-[17px] text-[#171717] dark:text-white font-medium mb-5 truncate" title={provider.name}>
          {provider.name}
        </h2>
