...
<path fill-rule="evenodd" clip-rule="evenodd" d="M17.3421 10.4615L19.6733 6.15711C19.7934 5.90833 19.7934 5.54802 19.6733 5.24347L16.9903 0.450069C16.8166 0.147666 16.4113 0.147666 16.2354 0.450069L13.9663 4.63438C13.8462 4.87458 13.8462 5.24347 13.9663 5.48368L16.585 10.4058C16.7608 10.7639 17.222 10.7639 17.3421 10.4615Z" fill="currentColor"/>
<path d="M33.7083 3.78727L31.8445 0.505876C31.6708 0.201329 31.2655 0.201329 31.0896 0.505876L23.225 15.0791C23.1135 15.3837 23.1135 15.6861 23.225 15.9263L25.3268 19.7524C25.5027 20.0548 25.908 20.0548 26.0817 19.7524L33.7726 5.54807C34.0579 4.99473 34.0579 4.33202 33.7083 3.78727Z" fill="currentColor"/>
</g>
<defs>
<clipPath id="clip0_177_345">
<rect width="33.2" height="19.817" fill="currentColor" transform="translate(0.800049 0.192627)"/>
</clipPath>
</defs>
</svg>
  ...
  return (
    <div className="flex flex-col justify-center gap-8">
      ...
      <div className="shadow-sm">
        <div className="grid w-full grid-cols-5 rounded-t-lg border border-[#D1D1D1] dark:border-[#2E2E2E]">
          {gpuTypes.map((item, index) => (
            <div
              ...
              className={clsx(
                ...
                index !== gpuTypes.length - 1 && index !== 1 && "border-r border-[#D1D1D1] dark:border-[#2E2E2E]",
              )}
            >
              <h3
                className={clsx(
                  "flex w-full items-center gap-1 text-[10px] md:gap-1.5 md:text-sm lg:text-lg whitespace-nowrap truncate",
              ...
              >
                {prices[0][index]}
                {index !== 0 && (
                  <span className="inline-flex text-xs md:text-[21px]">/hr</span>
                )}
              </h4>
            </div>
          ))}
                    ...
                    <h4
                      ...
                      className={clsx(
                        ...
                        i === 1
                          ...
                          : "dark:bg-[linear-gradient(16.2deg,#121212_16.73%,#191818_88.7%)] bg-[#EAEAEA] text-black dark:text-white",
                        i !== item.length - 1 && i !== 1 && "border-r border-[#D1D1D1] dark:border-[#2E2E2E]",
                      )}
                    >
                      {item}
                      {i !== 0 && (
                        <span className="inline-flex text-xs md:text-[21px]">
                          /hr
                        </span>
                      )}
                    </h4>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-1 rounded-b-md border-x border-b border-[#D1D1D1] dark:border-[#2E2E2E] bg-[#EAEAEA] dark:bg-[#191818] py-2.5 font-medium md:rounded-b-lg md:py-4 group/gpuprice"
        >
